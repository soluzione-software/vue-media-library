(function (global, factory) {
    ...
    __vue_render__$4._withStripped = true;
      ...
      var __vue_inject_styles__$4 = function (inject) {
        if (!inject) { return }
        inject("data-v-3d1509c2_0", { source: "\n.v-cropper[data-v-3d1509c2] {\n    max-height: 80vh;\n}\n", map: {"version":3,"sources":["/home/yuriy/gits/vue-media-library/src/components/ImageCropper.vue"],"names":[],"mappings":";AA4EA;IACA,gBAAA;AACA","file":"ImageCropper.vue","sourcesContent":["<template>\n    <cropper\n            ref=\"cropper\"\n            classname=\"v-cropper\"\n            :src=\"image\"\n            :stencil-props=\"stencilProps\"\n            :restrictions=\"restrictions\"\n    />\n</template>\n\n<script>\n    import { Cropper } from 'vue-advanced-cropper'\n\n    export default {\n        name: \"ImageCropper\",\n        components: {Cropper},\n        props: {\n            image: {\n                type: String,\n                required: true,\n            },\n            aspectRatio: {\n                type: Number\n            },\n            minWidth: {\n                type: Number\n            },\n            maxWidth: {\n                type: Number\n            },\n            minHeight: {\n                type: Number\n            },\n            maxHeight: {\n                type: Number\n            },\n        },\n        data(){\n            return {\n            }\n        },\n        methods: {\n            /**\n             *\n             * @param {BlobCallback} callback\n             * @param {string?} type\n             * @param {number?} quality\n             */\n            getResult(callback, type, quality){\n                this.$refs.cropper.getResult().canvas.toBlob(callback, type, quality);\n            },\n        },\n        computed: {\n            stencilProps(){\n                return {\n                    aspectRatio: this.aspectRatio,\n                }\n            },\n            restrictions(){\n                if (this.minWidth || this.minHeight || this.maxWidth || this.maxHeight){\n                    return () => {\n                        return {\n                            minWidth: this.minWidth,\n                            minHeight: this.minHeight,\n                            maxWidth: this.maxWidth,\n                            maxHeight: this.maxHeight,\n                        }\n                    }\n                }\n                return undefined;\n            },\n        }\n    }\n</script>\n\n<style scoped>\n    .v-cropper {\n        max-height: 80vh;\n    }\n</style>\n"]}, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__$4 = "data-v-3d1509c2";
      /* module identifier */
    ...
    var script$c = {
        name: "MediaLibrary",
        components: {ImageCropper: __vue_component__$4, Modal: __vue_component__$3, FilePicker: __vue_component__$2, Grid: __vue_component__$9, Single: __vue_component__$a, List: __vue_component__$b, LightBox: LightBox},
        mixins: [isDownloadable, isEditable, isViewable, usesPortal],
        props: {
            media: {
                type: Array,
